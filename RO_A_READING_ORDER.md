...
1. **README.md** — what belongs here, and the four things a statement needs before it earns an MB_#### number.
2. **RO_B_MATHEMATICAL_BASIS.md** — the source → statement → verification → result pipeline, walked through concretely using MB_0001.
3. **sources/persist/persist.pdf** — the historical source that motivated MB_0001, preserved as originally written.
