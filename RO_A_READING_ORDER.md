...
5. **papers/density-correction/paper.md** — the proof: theorem, argument, the 9423 correspondence audit, and the label/reading/specification distinction that audit motivated.
6. **tests/MB_0001_general_sweep.py** — the executable verification. Runnable as-is.
7. **results/MB_0001_general_sweep.yaml** — the stored output of running that script, not a paraphrase of it.
